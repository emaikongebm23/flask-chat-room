...
# hexa from 60 digit integer
hash_obj = hashlib.sha512(
    b'0x9f17cd320d8d4abd9dc18535391dd0b09784dcd9590d9fc11764331eae69f0b1389d3582ab69ef71fa6605dc470b5f3737f581c2807f9f')
...
@app.route('/spec')
def get_spec():
    return send_from_directory(app.root_path, 'api-docs.yaml')
